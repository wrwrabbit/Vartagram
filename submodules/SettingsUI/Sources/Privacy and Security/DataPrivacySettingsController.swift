...
private func dataPrivacyControllerEntries(presentationData: PresentationData, state: DataPrivacyControllerState, secretChatLinkPreviews: Bool?, synchronizeDeviceContacts: Bool, frequentContacts: Bool, hasBotSettings: Bool, isHidableAccount: Bool) -> [DataPrivacyEntry] {
...
public func dataPrivacyController(context: AccountContext, focusOnItemTag: DataPrivacyEntryTag? = nil) -> ViewController {
    ...
    |> map { presentationData, state, noticeView, sharedData, preferences, recentPeers, hasBotSettings, isHidableAccount -> (ItemListControllerState, (ItemListNodeState, Any)) in
