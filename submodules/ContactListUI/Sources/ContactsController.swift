...
public class ContactsController: ViewController {
    ...
    @objc func addPressed() {
        if self.context.immediateIsHidable {
            ...
            let controller = UndoOverlayController(presentationData: self.presentationData, content: .info(title: nil, text: self.presentationData.strings.FunctionalityUnavailableForHidableAccounts, timeout: nil, customUndoText: nil), elevatedLayout: false, action: { _ in return false })
