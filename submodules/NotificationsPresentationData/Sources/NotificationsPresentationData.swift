...
public struct NotificationsPresentationData: Codable, Equatable {
    ...
    public init(applicationLockedMessageString: String, incomingCallString: String, messagePhoto: String, messageVideo: String, messageSticker: String, messageVoice: String, messageAnimation: String, messageFile: String) {
