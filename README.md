...
3. Please study Telegram [**security guidelines**](https://core.telegram.org/mtproto/security_guidelines) and take good care of your users' data and privacy.
...
In case if you have no Developer account you still can build Vartagram with your Apple ID.
